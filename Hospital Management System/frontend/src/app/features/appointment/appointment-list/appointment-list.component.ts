  ...
  columnDefs: ColDef<Appointment>[] = [
    ...
    },
    {
      ...
      cellRenderer: (params: ICellRendererParams<Appointment>) => {
        ...
        return `
          <button class="cancel-btn btn btn-sm ${cancelled ? 'btn-primary' : 'btn-outline-dark'}">
    ...
    },
    {
      ...
      cellRenderer: () => `
        ...
        <button class="btn btn-warning btn-sm edit-btn ms-1">Edit</button>
